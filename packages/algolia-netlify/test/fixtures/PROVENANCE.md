...
webhook secrets, or customer data. The frozen Algolia record expectation is
reused from `expected-algolia-records.json`; it is not generated by the
implementation during a test run.
