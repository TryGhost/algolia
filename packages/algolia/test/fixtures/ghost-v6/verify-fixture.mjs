...
const expectedHashes = {
    ...
    'validate-fixture.mjs': 'e2233a3a892b331db81807ef13a1dc7630d3b3ca00ba405d620d491308e212ad',
    ...
    'expected-algolia-records.json':
        'ea8f562606161641b54ccb4d52f2fe382cbe00942ea58564fba9cd9e9b5ca31a',
    'expected-index-settings.json':
        'ed515127d16fa025e3f4b13e9f9d360273e18a750162c0bdf7d217c7de8c1a08'
};
...
console.log(`Verified ${Object.keys(expectedHashes).length} Ghost 6 fixture files.`);
